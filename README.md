# Dupery-Bluff
A mod for Demon Bluff that adds several roles from Dupery into the game.

This mod adds the following characters:
### Villagers
- Artist - Learns a role that an Evil character is Disguised as.
- Blood Hound - Learns the direction from itself to its closest Evil.
...
- Priest - Learns "I am the Priest".
- Private Eye - After 5 Reveals, Learns an unrevealed Minion.
- Reporter - Learns its distance to the nearest Evil.
- Researcher - Picks 1 character & Learns if they're Innocent.
- Romantic - Learns an adjacent Villager.
- Skeptic - Learns a character and their alignment. Loses faith if your health gets low.
- Tailor - Picks 2 characters & Learns if they are the same alignment.
- Therapist - Learns how many Evil characters are adjacent to it.
...
- Fall Guy - Registers as an Evil Minion.
- Surgeon - After 6 Reveals, might kill a Good character.
- Wannabe - Disguises as a Minion. Makes a Minion flip face-up.
- Youngster - Deals double damage when Executed.
### Minions
- Bad Cop - Disguises as the Good Cop. Only shows up alongside the Good Cop.
...
- Hitman - Kills someone every 2 Reveals. Lies and Disguises.
- Idol - Corrupts Villagers adjacent to it. Lies and Disguises.
- Kingpin - Corrupts a nearby Villager and turns another nearby Villager Evil. Lies and Disguises.
- Recruiter - Turns all Outcasts Evil. Lies and Disguises.
